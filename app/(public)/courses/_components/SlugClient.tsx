                    ...
                    <div className="border-t bg-muted/20">
                      <div className="p-6 pt-4 space-y-3">
                        {chapter.lessons.map((lesson, lessonIndex) => (
                          ...
                          >
                            <div className="flex size-8 items-center justify-center rounded-full bg-background border-2 border-primary/40">
        ...
        <div className="sticky top-20">
          <Card className="py-0">
            <CardContent className="p-6">
              ...
              <div className="my-6 space-y-3 rounded-lg bg-muted p-4">
