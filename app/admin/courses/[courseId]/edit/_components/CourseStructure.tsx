...
import { Course, reorderChapters, reorderLessons } from "../../actions";
...
export function CourseStructure({ data }: iAppProps) {
  ...
  function handleDragEnd(event: DragEndEvent) {
    ...
    if (activeType === "chapter") {
      ...
      if (!targetChapterId) {
        toast.error("Couldn`t determine chapter for reordering");
        return;
      }
    ...
    if (activeType === "lesson" && overType === "lesson") {
      ...
      if (!chapterId || chapterId !== overChapterId) {
        toast.error(
          "Lesson move between different chapters or invalid chapter id are not allowed"
        );
        return;
      }
      ...
      if (oldLessonIndex === -1 || newLessonIndex === -1) {
        toast.error("Couldn`t determine lesson for reordering");
        return;
      }
